---
title: "How Big Black Holes Are, and Why Their Waves Reach Us"
description: "How large is the black hole at the center of the galaxy, and how can a collision a billion light-years away move anything here? Following a guess that the answer had to be solar-system sized."
pubDate: 2026-08-22
tags:
  - physics
  - astronomy
...
The question came out of learning what gravitational waves are, and getting stuck on the distance.

The detections come from black holes merging elsewhere in the universe — the first confirmed one from a collision roughly 1.3 billion light-years away. That number is the problem. A billion light-years is far enough that whatever happened out there should be entirely irrelevant here, and yet an instrument on the ground picked it up. Something has to account for how a disturbance at that range arrives with anything left in it at all.

The proposal that followed:

### The black holes must have been enormous — possibly the size of the solar system
...
| Object | Mass (Suns) | Horizon diameter | Comparable to |
|---|---|---|---|
| Smallest stellar black holes | ~3 | ~18 km | A large city |
| The two that merged | 36 and 29 | ~210 km, ~170 km | Los Angeles to San Diego |
| Their merged remnant | ~62 | ~370 km | A tenth of the Moon's width |
| Sagittarius A\* | 4,300,000 | ~25,000,000 km | 18 Suns; a fifth of Mercury's orbit |
| The largest known | tens of billions | hundreds of billions of km | Several times Neptune's orbit |
...
- A 36-solar-mass black hole packs roughly 10^16 kg into every cubic meter — about **ten trillion times** the average density of the Sun.
- Sagittarius A\*, despite being 120,000 times heavier, sits at roughly 10^6 kg per cubic meter: only about 700 times the Sun's average density, around 1,000 times water.
- Above roughly 140 million solar masses, the average density inside the horizon drops **below water**. Above a few billion, it drops below air.
...
| Source mass (Suns) | Wave frequency | Wave period | What can hear it |
|---|---|---|---|
| 10–100 | 10–1,000 Hz | milliseconds | Ground interferometers, km-scale arms (LIGO, Virgo, KAGRA) |
| 10⁵–10⁷ | 0.1–100 millihertz | minutes to hours | Space interferometer, million-km arms (LISA) |
| 10⁸–10¹⁰ | nanohertz | years to decades | Pulsar timing arrays — the galaxy as the instrument |
...
- **Below ~5 solar masses** (neutron stars): quiet. Detectable only relatively nearby — hundreds of millions of light-years rather than billions.
- **20–200 solar masses total**: the ground-detector sweet spot. Heavy enough to be loud, light enough that the merger still happens inside the audio band.
- **Above ~200 solar masses**: louder in absolute terms, but the merger frequency slides below the instrument's floor. The event falls off the bottom of its hearing.
...
- **The intermediate-mass gap.** Between roughly 100 and 100,000 solar masses, detections are sparse. Whether black holes populate that range in numbers, and how they would form, is unsettled.
- **How the merging pairs got close in the first place.** Two black holes have to lose an enormous amount of orbital energy to reach the separation where gravitational waves take over. Whether that happens through a shared gas envelope, through gravitational encounters in dense star clusters, or some mix, is an open question.
- **The nanohertz background.** Pulsar timing arrays have found evidence of a low-frequency hum consistent with many supermassive pairs across the sky. Attributing it confidently to those pairs — rather than to something from the early universe — is ongoing work.

## Sources

- [Sagittarius A\* — Britannica](https://www.britannica.com/place/Sagittarius-A-astronomy) and [Space.com](https://www.space.com/sagittarius-a) — mass and event horizon scale
- [GW150914 press release — LIGO Caltech](https://www.ligo.caltech.edu/page/press-release-gw150914) — masses, distance, three solar masses radiated, near-half-light-speed collision
- [Properties of the Binary Black Hole Merger GW150914 (arXiv:1602.03840)](https://arxiv.org/abs/1602.03840) — peak luminosity 3.6 × 10^56 erg/s, source-frame masses, 410 Mpc luminosity distance
- [LIGO Facts — Caltech](https://www.ligo.caltech.edu/page/facts) and [LIGO: The Laser Interferometer Gravitational-Wave Observatory (arXiv:0711.3041)](https://arxiv.org/pdf/0711.3041) — strain sensitivity, arm-length displacement, proton-width comparison
- [Fun with Gravitational Waves — Scientific American](https://blogs.scientificamerican.com/life-unbounded/fun-with-gravitational-waves/) — the ~200 watt Earth–Sun figure
- [LIGO on the pulsar timing array detection](https://www.ligo.caltech.edu/LA/news/ligo20230628) and [Gravitational wave physics with LISA and pulsar timing arrays](https://www.ctc.cam.ac.uk/activities/rise/slides/gair.pdf) — detector frequency bands
- [Merging Supermassive Black Holes Will Become The Most Energetic Events Of All — Forbes](https://www.forbes.com/sites/startswithabang/2020/03/03/the-most-energetic-event-in-the-universe-hasnt-been-discovered-yet/) — brightness relative to all starlight in the observable universe
