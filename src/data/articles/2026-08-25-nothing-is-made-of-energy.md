---
title: "Nothing Is Made of Energy"
description: "In lightning and a static shock — is it photons, or electrons? And underneath that: is everything in the universe, matter included, just states of energy?"
pubDate: 2026-08-25
session: 2026-08-25-energy-and-fields
section: science
related:
  - white-holes-and-the-arrow-of-time
  - black-hole-size-gravitational-waves
tags:
  - physics
  - electromagnetism
...
- **Electrons carry the charge.** They are what got displaced and what returns.
- **The electromagnetic field carries the energy and the force.** It stores the work you did and delivers it.
- **Photons are what that field is made of.** This is the quantum description of the same thing. When two charges push on each other, the interaction is carried by photons — *virtual* photons, meaning excitations of the field that exist only as part of the interaction rather than flying off as light. Saying "the field pushes them apart" and "photons carry the force between them" are the same statement at two resolutions.
- **And some photons fly off as light** — the ones emitted when excited atoms in the channel settle back down. Those are the only ones you see, which is exactly why they are the misleading ones.
...
|---|---|
| shift everything in time | energy |
| shift everything in space | momentum |
| rotate everything | angular momentum |
...
| The intuition | The correction |
|---|---|
| One common substrate underlies everything | Yes — fields |
| Everything is a state of that substrate | Yes — particles are excitations |
| The substrate is energy | No — energy is a number describing how much excitation there is |
| Different energy levels give different things | No — different *fields* give different things |
