---
title: "Worms With Extensions"
description: "Everything with a front and a back is a worm with extensions. What that body plan is, how a small set of reused genetic switches builds it, why a whale shows it better than anything alive, and where the picture is still unsettled."
pubDate: 2026-08-21
tags:
  - biology
  - evolution
...
- **Bilateral symmetry** — a left and a right, and therefore a front and a back.
- **A through-gut** — a digestive tube running the length of the body, with a mouth at one end and an anus at the other. Material enters, is stripped of what is useful, and exits. This is the tube-within-a-tube.
- **A defined head-to-tail axis** — positions along the body are distinct and specified.
- **Three tissue layers** in the embryo, including a middle layer that produces muscle and internal organs.
- **Nervous tissue concentrated toward the front**, where new information arrives first.
...
![Diagram of the bilaterian body plan: an outer body tube with an inner gut tube running through it](/images/biology/tube-within-a-tube.svg)
...
![A translucent comb jelly photographed against black water](/images/biology/comb-jelly.jpg)
...
![Diagram showing Hox gene order along a chromosome matching head-to-tail body order in a fly and a vertebrate](/images/biology/hox-colinearity.svg)
...
![Diagram comparing arm and leg bones, both following a one-bone, two-bone, many-bone sequence](/images/biology/limb-serial-homology.svg)
...
![Diagram showing that shorter wavelength in a chemical pattern produces more and thinner digits](/images/biology/digit-wavelength.svg)
...
![Diagram of the developmental hourglass showing species converging in mid-development](/images/biology/developmental-hourglass.svg)
...
- Whales lost their hind limbs entirely; the pelvis is reduced to bone with no limb attached.
- Snakes lost their limbs.
- Cave fish have regressed their eyes independently, in many separate lineages — while *enhancing* other senses, expanding the lateral line and multiplying taste buds.
- Subterranean mammals have inactivated eye-specific genes outright.
- Parasites shed enormous fractions of their gene content.
...
![A pale, eyeless cave tetra](/images/biology/cavefish.jpg)
...
![A segmented marine ragworm photographed against black](/images/biology/ragworm.jpg)
...
![A sperm whale and calf underwater](/images/biology/sperm-whale.jpg)
...
![A humpback whale lunge feeding at the surface with its mouth open and throat pleats distended](/images/biology/lunge-feeding.jpg)
...
![A small translucent lancelet, pointed at both ends, with no distinct head](/images/biology/amphioxus.jpg)
...
![A reconstruction drawing of the long serpentine skeleton of the early whale Basilosaurus](/images/biology/basilosaurus.jpg)
...
![A small simple flatworm viewed under a microscope](/images/biology/acoel.jpg)
...
![A simple featureless marine worm, Xenoturbella](/images/biology/xenoturbella.jpg)
...
- [Ancient gene linkages support ctenophores as sister to other animals — *Nature* (2023)](https://www.nature.com/articles/s41586-023-05936-6)
- [The Presence of a Functionally Tripartite Through-Gut in Ctenophora — *Current Biology* (2016)](https://www.cell.com/current-biology/fulltext/S0960-9822(16)30931-9)
- [Sponges, ctenophores, and the statistical significance of syntenies — *MBE*](https://academic.oup.com/mbe/article/42/12/msaf321/8373738)
- [Xenacoelomorpha is the sister group to Nephrozoa — *Nature*](https://www.nature.com/articles/nature16520)
- [Filtering artifactual signal supports Xenacoelomorpha + Ambulacraria — *Current Biology*](https://www.sciencedirect.com/science/article/pii/S0960982222016840)
- [A Phylogenomic Backbone for Acoelomorpha — *Systematic Biology* (2025)](https://academic.oup.com/sysbio/article/74/1/70/7841810)
- [Segmented Urbilateria: A Testable Scenario — *Integr. Comp. Biol.*](https://academic.oup.com/icb/article/43/1/137/604487)
- [The urbilaterian brain revisited — *Dev. Genes Evol.*](https://pmc.ncbi.nlm.nih.gov/articles/PMC3873165/)

**Hox genes, duplication, and limb patterning**

- [Hox gene colinearity in the annelid *Capitella*](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC2603591/)
- [Two Rounds of Whole Genome Duplication in the Ancestral Vertebrate — *PLOS Biology*](https://journals.plos.org/plosbiology/article?id=10.1371%2Fjournal.pbio.0030314)
- [A new look at an old question: when did the second whole genome duplication occur? — *Genome Biology*](https://genomebiology.biomedcentral.com/articles/10.1186/s13059-018-1592-0)
- [Tbx5 and Tbx4 genes determine the wing/leg identity of limb buds — *Nature*](https://www.nature.com/articles/19762)
- [Divergent transcriptional activities determine limb identity — *Nature Communications*](https://www.nature.com/articles/ncomms1036)
- [Pitx1 determines the morphology of muscle, tendon, and bones of the hindlimb](https://pubmed.ncbi.nlm.nih.gov/16989801/)
- [Hox Genes Regulate Digit Patterning by Controlling the Wavelength of a Turing-Type Mechanism — *Science* (2012)](https://www.science.org/doi/10.1126/science.1226804)
- [Biphasic Hoxd expression in shark fins reveals an ancient origin of the distal limb domain](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC1937022/)

**Developmental constraint and trait loss**

- [Genomic hourglass — *Nature*](https://www.nature.com/articles/468768a)
- [Evidence for Active Maintenance of Phylotranscriptomic Hourglass Patterns — *MBE*](https://academic.oup.com/mbe/article/32/5/1221/1125964?login=false)
- [The Hourglass and the Early Conservation Models — *PLOS Genetics*](https://journals.plos.org/plosgenetics/article?id=10.1371%2Fjournal.pgen.1003476)
- [Inverting the hourglass: quantitative evidence against the phylotypic stage in vertebrate development](https://pubmed.ncbi.nlm.nih.gov/12639312/)
- [Gene Expression Does Not Support the Developmental Hourglass Model in Three Animals with Spiralian Development — *MBE* (2019)](https://academic.oup.com/mbe/article/36/7/1373/5415916)
- [Regressive evolution: limb loss in snakes and eye degeneration in subterranean mammals — MPI-CBG](https://www.mpi-cbg.de/news-outreach/news-media/article/regressive-evolution-limb-loss-in-snakes-and-degeneration-of-eyes-in-subterranean-mammals)
- [Trait Loss in Evolution: What Cavefish Have Taught Us — *Integr. Comp. Biol.*](https://academic.oup.com/icb/article/63/2/393/7176060)
- [What can vertebrates tell us about segmentation? — *EvoDevo*](https://link.springer.com/article/10.1186/2041-9139-5-24)

**Sensory systems**

- [Ciliary Photoreceptors with a Vertebrate-Type Opsin in an Invertebrate Brain — *Science* (2004)](https://www.science.org/doi/10.1126/science.1099955)
- [Induction of Ectopic Eyes by Targeted Expression of the eyeless Gene in Drosophila — *Science* (1995)](https://www.science.org/doi/10.1126/science.7892602)
- [Convergent sequence evolution between echolocating bats and dolphins — *Current Biology*](https://www.sciencedirect.com/science/article/pii/S0960982209020739)
- [Parallel Sites Implicate Functional Convergence of the Hearing Gene Prestin — *MBE*](https://academic.oup.com/mbe/article/31/9/2415/2925800)
- [No Genome-Wide Protein Sequence Convergence for Echolocation — *MBE* (2015)](https://academic.oup.com/mbe/article/32/5/1237/1126808)
- [A functional enrichment test for molecular convergent evolution finds a clear protein-coding signal in echolocating bats and whales — *PNAS*](https://www.pnas.org/doi/full/10.1073/pnas.1818532116)

**Whales and chordate feeding**

- [Lunge Feeding in Rorqual Whales — *Physiology*](https://journals.physiology.org/doi/full/10.1152/physiol.00010.2019)
- [Mechanics, hydrodynamics and energetics of blue whale lunge feeding — *J. Exp. Biol.*](https://journals.biologists.com/jeb/article/214/1/131/10226/Mechanics-hydrodynamics-and-energetics-of-blue)
- [Discovery of a sensory organ that coordinates lunge feeding in rorqual whales — *Nature* (2012)](https://www.nature.com/articles/nature11135)
- [Sexual selection targets cetacean pelvic bones — *Evolution* (2014)](https://onlinelibrary.wiley.com/doi/full/10.1111/evo.12516)
- [Amphioxus as a model to study the evolution of development in chordates — *eLife*](https://elifesciences.org/articles/87028)
- [Thyroid and endostyle development in cyclostomes — *BMC Biology* (2022)](https://link.springer.com/article/10.1186/s12915-022-01282-7)
- [Cranial convergence between *Hupehsuchus* and baleen whales — *BMC Ecol. Evol.*](https://link.springer.com/article/10.1186/s12862-023-02143-9)

**Thermodynamics**

- [Dissipative structures in biological systems — *Phil. Trans. R. Soc. A*](https://royalsocietypublishing.org/doi/10.1098/rsta.2017.0376)
