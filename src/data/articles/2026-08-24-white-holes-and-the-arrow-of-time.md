---
title: "What the Equations Allow, and What the Universe Actually Did"
description: "Isn't a white hole just a black hole running in reverse — and could our universe be the Hawking radiation of an enormous one? Two attempts to get a beginning out of time-symmetric physics."
pubDate: 2026-08-24
tags:
  - physics
  - cosmology
...
- [Death of White Holes in the Early Universe — Eardley, Phys. Rev. Lett. 33, 442 (1974)](https://link.aps.org/doi/10.1103/PhysRevLett.33.442) — the exponential instability converting white holes into black holes
- [Death of white holes — Blau, Phys. Rev. D 47, 2383 (1993)](https://journals.aps.org/prd/abstract/10.1103/PhysRevD.47.2383) — refinement attributing the death to accreting material rather than the blueshift divergence
- [Maximal extension of the Schwarzschild metric (arXiv:2005.14211)](https://arxiv.org/pdf/2005.14211) — the four Kruskal–Szekeres regions, and that no gravitational process realizes regions III and IV
- [Hawking temperature and evaporation time references](https://calcoi.com/en/calculator/hawking-temperature-black-hole-radiation-calculator/) — the inverse-mass temperature relation and the cubic evaporation lifetime
- [The Cosmic Microwave Background Spectrum from the Full COBE FIRAS Data Set](https://iopscience.iop.org/article/10.1086/178173) and [COBE — Scholarpedia](http://www.scholarpedia.org/article/Cosmic_background_explorer) — blackbody fit to 50 parts per million, isotropy to 10 parts per million after removing our motion
- [A Larger Estimate of the Entropy of the Universe — Egan & Lineweaver (arXiv:0909.3983)](https://arxiv.org/abs/0909.3983) — CMB entropy 2.03 × 10⁸⁹, observable-universe total 3.1 × 10¹⁰⁴ dominated by supermassive black holes, cosmic event horizon 2.6 × 10¹²²
- [On the Weyl Curvature Hypothesis (arXiv:1203.3382)](https://arxiv.org/abs/1203.3382) — why low initial entropy must come from geometry, since the matter fields began in thermal equilibrium
- [Topological Defects in Cosmology (arXiv:astro-ph/0110285)](https://arxiv.org/pdf/astro-ph/0110285) and [Power Spectra in Global Defect Theories (arXiv:astro-ph/9704165)](https://arxiv.org/pdf/astro-ph/9704165) — coherence of the acoustic peaks, and why incoherent random sources are excluded
- [The Universe is Not a Black Hole — Sean Carroll](https://preposterousuniverse.com/blog/2010/04/28/the-universe-is-not-a-black-hole/) — why the observable universe's mass having a Schwarzschild radius near its own size is a restatement of spatial flatness, not evidence of anything
